...
This sample module contains one small method that filters contigs.
    ...
    def run_suminwContigFilter(self, ctx, params):
        """
        ...
        #BEGIN run_suminwContigFilter

        # Print statements to stdout/stderr are captured and available as the App log
        logging.info('Starting run_suminwContigFilter function. Params=' + pformat(params))
        ...
        #END run_suminwContigFilter

        # At some point might do deeper type checking...
        if not isinstance(output, dict):
            raise ValueError('Method run_suminwContigFilter return value ' +
                             'output is not type dict as required.')
        # return the results
        return [output]

    def run_suminwContigFilter_max(self, ctx, params):
        """
        ...
        # ctx is the context object
        # return variables are: output
        #BEGIN run_suminwContigFilter_max
        ...
        #END run_suminwContigFilter_max

        # At some point might do deeper type checking...
        if not isinstance(output, dict):
            raise ValueError('Method run_suminwContigFilter_max return value ' +
                             'output is not type dict as required.')
        # return the results
        return [output]
    def status(self, ctx):
